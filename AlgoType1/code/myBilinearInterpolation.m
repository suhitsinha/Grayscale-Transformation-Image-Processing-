...
for i = 1: opm
    for j = 1 : opn
        ...
        elseif j == opn
            ...
            op_pic2(i,j) = (ip_pic2(r,c)*(1- del_row_frac_loc(1,i)) * (1 - del_col_frac_loc(1,j))) + (ip_pic2(r+1,c)*del_row_frac_loc(1,i) * (1 - del_col_frac_loc(1,j)))+ (ip_pic2(r,c+1)*(1- del_row_frac_loc(1,i)) * del_col_frac_loc(1,j))+ (ip_pic2(r+1,c+1)*(del_row_frac_loc(1,i)) * (del_col_frac_loc(1,j)));
        end
    end
end
